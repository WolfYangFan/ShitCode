var css = `.MCExp_AprilFools_HealthbarWrapper{position:relative;z-index:21}.MC_globalHeaderB_sticky .MCExp_AprilFools_HealthbarWrapper{position:fixed;top:var(--placeholderHeight);left:50%;transform:translateX(-50%)}.MCExp_AprilFools_Healthbar{display:flex;flex-wrap:nowrap;position:absolute;left:50%;transform:translateX(-50%);margin-top:10px;margin-left:0}.MCExp_AprilFools_HealthBar_Heart{background:url('/content/dam/minecraftnet/franchise/experiments/aprilFools/2024/heart-states.png?v=1') no-repeat left top;width:36px;height:36px}.MCExp_AprilFools_HealthBar_Poisoned .MCExp_AprilFools_HealthBar_Heart{background-position:left -36px}.MCExp_AprilFools_HealthBar_Poisoned .MCExp_AprilFools_HealthBar_HeartHalf{background-position:left -72px}.MCExp_AprilFools_HealthBar_HeartEmpty{background-position:left bottom!important}@media screen and (min-width:1150px) and (max-width:1400px){.MC_globalHeaderB_sticky .MCExp_AprilFools_HealthbarWrapper{margin-top:36px}}@media screen and (max-width:540px){.MCExp_AprilFools_Healthbar{max-width:320px}}.MCExp_AprilFools_PoisonPotato{position:absolute;width:128px;height:128px;background-image:url('/content/dam/minecraftnet/franchise/experiments/aprilFools/2024/poison-potato.png');z-index:2;background-color:transparent;border:0;background-size:contain;visibility:visible;opacity:1}.MCExp_AprilFools_PoisonPotato:focus{outline:2px solid var(--mc-default-focus);box-shadow:0 0 0 3px var(--mc-core-white)}.MCExp_AprilFools_PoisonPotato_Shake{animation:taterShake .75s cubic-bezier(.36,.07,.19,.97) both}.MCExp_AprilFools_PoisonPotato_Fade{visibility:hidden;opacity:0;transition:visibility 0s .5s,opacity .5s linear}@media screen and (max-width:1200px){.MCExp_AprilFools_PoisonPotato{width:96px;height:96px}}@media screen and (max-width:767.98px){.MCExp_AprilFools_PoisonPotato{width:64px;height:64px}}@media screen and (min-width:541px){.MCExp_AprilFools_Healthbar{margin-left:16px}.MCExp_AprilFools_Healthbar>span{position:relative}.MCExp_AprilFools_Healthbar>span:nth-child(2){left:-4px}.MCExp_AprilFools_Healthbar>span:nth-child(3){left:-8px}.MCExp_AprilFools_Healthbar>span:nth-child(4){left:-12px}.MCExp_AprilFools_Healthbar>span:nth-child(5){left:-16px}.MCExp_AprilFools_Healthbar>span:nth-child(6){left:-20px}.MCExp_AprilFools_Healthbar>span:nth-child(7){left:-24px}.MCExp_AprilFools_Healthbar>span:nth-child(8){left:-28px}.MCExp_AprilFools_Healthbar>span:nth-child(9){left:-32px}.MCExp_AprilFools_Healthbar>span:nth-child(10){left:-36px}}#MC_AprilFools_Modal{max-width:unset;width:615px}#MC_AprilFools_Modal .MC_modal_cover{background:radial-gradient(59.14% 105.14% at 50% 50%,rgba(114,164,32,.3) 51.22%,rgba(63,142,26,.6) 100%),rgba(0,0,0,.6);background-blend-mode:hard-light,normal}#MC_AprilFools_Modal .MC_modal_cover:before{content:'';display:block;opacity:.5;position:absolute;width:100%;height:100%;top:0;left:0;background:url('/content/dam/minecraftnet/franchise/experiments/aprilFools/2024/ToxfinOverlay_Final_1064x986.png') no-repeat center center}#MC_AprilFools_Modal .MC_AprilFools_Modal_Content{display:flex;flex:0 0 100%;flex-direction:column;gap:14px;color:var(--mc-core-white);text-align:center;padding:16px}#MC_AprilFools_Modal h2{text-shadow:8px 8px 0 rgba(0,0,0,.5);font-family:var(--mc-legends-fontlist);font-size:6.25rem;font-style:normal;font-weight:400;line-height:6.25rem;margin:0}#MC_AprilFools_Modal .MC_AprilFools_Modal_Score,#MC_AprilFools_Modal .MC_AprilFools_Modal_Subtitle{font-family:var(--mc-legends-fontlist);text-shadow:3px 3px 0 rgba(0,0,0,.5);font-size:1.875rem;font-style:normal;font-weight:400}#MC_AprilFools_Modal .MC_AprilFools_Modal_Score_Value{color:#ffe500}#MC_AprilFools_Modal .MC_AprilFools_Modal_Actions .MC_Style_Java{box-shadow:-8px -16px 0 0 rgba(0,0,0,.3) inset,8px 8px 0 0 rgba(255,255,255,.3) inset;background:url('/content/dam/minecraftnet/franchise/experiments/aprilFools/2024/Button-BG_Java-Texture.png') repeat;width:100%;max-width:unset;align-items:center;color:var(--mc-core-white);text-shadow:4px 4px 0 #3e3e3e;font-family:var(--mc-legends-fontlist);font-size:2.5rem;font-style:normal;font-weight:400;line-height:normal;height:80px;text-transform:none;border:4px solid var(--mc-core-rich-black)}#MC_AprilFools_Modal .MC_AprilFools_Modal_Actions .MC_Style_Java:hover{border-color:var(--mc-core-white)}#MC_AprilFools_Modal .MC_AprilFools_Modal_Actions .MC_Style_Java:focus{outline:2px solid var(--mc-core-white);outline-offset:-2px;border-color:var(--mc-default-focus)}#MC_AprilFools_Modal .MC_AprilFools_Modal_Actions .MC_Style_Java>span{position:relative;top:-4px}.MC_AprilFools__cancel .MCExp_AprilFools_Healthbar,.MC_AprilFools__cancel .MCExp_AprilFools_PoisonPotato{display:none}@media screen and (max-width:1050px){#MC_AprilFools_Modal .MC_modal_cover:before{background-size:cover}}@media screen and (max-width:645px){#MC_AprilFools_Modal{width:100%}}@media screen and (max-width:540px){#MC_AprilFools_Modal h2{font-size:4.25rem}#MC_AprilFools_Modal .MC_AprilFools_Modal_Score,#MC_AprilFools_Modal .MC_AprilFools_Modal_Subtitle{font-size:1.25rem}#MC_AprilFools_Modal .MC_AprilFools_Modal_Actions .MC_Style_Java{font-size:1.875rem;height:60px}}@media screen and (max-width:767.98px){.MC_video_rollupToggle{top:55px}}@media screen and (max-width:540px){.MC_CardE{padding-top:60px}}#taterAnimationToggle_0{position:relative}#taterAnimationToggle_0 .MC_Animation_action__aprilFoolsAnimationToggle{display:flex;max-width:165px;min-height:34px;flex-direction:row;align-items:center;padding:4px 4px 4px 8px;gap:0;position:absolute;left:0;top:15px;width:auto;background:var(--mc-core-rich-black);box-shadow:0 2px 0 rgba(0,0,0,.2);font-size:.875rem;color:var(--mc-core-grey-1);border:0;z-index:250;width:auto!important;border:2px solid #5b5b5b;border-left:0}#taterAnimationToggle_0 .MC_Animation_action__aprilFoolsAnimationToggle::after{content:' ';display:block;width:26px;height:24px;background-size:contain!important;position:relative;left:-2px}#taterAnimationToggle_0 .MC_Animation_action__aprilFoolsAnimationToggle[data-paused=false]::after{aspect-ratio:52/48;background:url('/content/dam/minecraftnet/franchise/experiments/aprilFools/2024/disable-potatoes.png') no-repeat}#taterAnimationToggle_0 .MC_Animation_action__aprilFoolsAnimationToggle[data-paused=true]::after{aspect-ratio:52/48;background:url('/content/dam/minecraftnet/franchise/experiments/aprilFools/2024/enable-potatoes.png') no-repeat}#taterAnimationToggle_0 .MC_Animation_action__aprilFoolsAnimationToggle_Wrapper{transition:width .7s ease-out;overflow:hidden;position:relative;left:-4px}#taterAnimationToggle_0 .MC_Animation_action__aprilFoolsAnimationToggle_Wrapper .MC_Animation_action__aprilFoolsAnimationToggle_Text{padding-right:10px}#taterAnimationToggle_0 .MC_Animation_action__aprilFoolsAnimationToggle_Text{word-wrap:break-word}#taterAnimationToggle_0 .MC_Animation_action__aprilFoolsAnimationToggle:focus::before{content:'';position:absolute;width:100%;height:100%;outline:2px solid var(--mc-default-focus);box-shadow:0 0 0 3px var(--mc-core-white);outline-offset:0;width:calc(100% - 4px);left:3px}@media screen and (max-width:767.98px){#taterAnimationToggle_0 .MC_Animation_action__aprilFoolsAnimationToggle{top:55px}}#taterAnimationToggle_0 .MC_Animation__aprilFoolsAnimationToggle_sticky{position:fixed;left:0;top:inherit;margin-top:15px}@media (forced-colors:active){#taterAnimationToggle_0 .MC_Animation_action__aprilFoolsAnimationToggle[data-paused=false]::before,#taterAnimationToggle_0 .MC_Animation_action__aprilFoolsAnimationToggle[data-paused=true]::before{filter:invert(1)}}@media (forced-colors:active) and (prefers-color-scheme:light){#taterAnimationToggle_0 .MC_Animation_action__aprilFoolsAnimationToggle:focus,#taterAnimationToggle_0 .MC_Animation_action__aprilFoolsAnimationToggle:focus-visible{right:3px}#taterAnimationToggle_0 .MC_Animation_action__aprilFoolsAnimationToggle:focus-visible::after,#taterAnimationToggle_0 .MC_Animation_action__aprilFoolsAnimationToggle:focus::after{filter:invert(1);width:100%;outline-offset:1px}#taterAnimationToggle_0 .MC_Animation_action__aprilFoolsAnimationToggle:focus-visible:before,#taterAnimationToggle_0 .MC_Animation_action__aprilFoolsAnimationToggle:focus:before{left:14px}#taterAnimationToggle_0 .MC_Animation_action__aprilFoolsAnimationToggle:focus .MC_Animation_action__aprilFoolsAnimationToggle_Wrapper,#taterAnimationToggle_0 .MC_Animation_action__aprilFoolsAnimationToggle:focus-visible .MC_Animation_action__aprilFoolsAnimationToggle_Wrapper{position:relative;left:3px}}.MC_Animations_PoisonSwirl{position:fixed;animation:poisonSwirlDisplayNone 1.5s;z-index:100;--height:64;height:64px;--frames:7;--width:448;animation-timing-function:linear;animation-name:poisonSwirlUp}.MC_Animations_PoisonSwirl::after{background-image:var(--bg-asset, url('/content/dam/minecraftnet/franchise/experiments/aprilFools/2024/PoisonParticleSequence.png'))}@keyframes poisonSwirlUp{0%{top:var(--mouse-y)}100%{top:var(--mouse-y-offset)}}@keyframes poisonSwirlDisplayNone{100%{display:none}}@keyframes taterShake{10%,90%{transform:translate3d(-1px,0,0)}20%,80%{transform:translate3d(2px,0,0)}30%,50%,70%{transform:translate3d(-4px,0,0)}40%,60%{transform:translate3d(4px,0,0)}}`;
          ...
          utility: {
            ...
            url: {
              locale: function () {
                ...
                return (
                  e && (t = e[1].split("-")),
                  { lang: t[0], region: t[1], construct: t[0] + "-" + t[1] }
                );
              },
            },
            wait: {
      ...
      window
        .staticExperimentConfig({
          experimentBase: function (e) {
            ...
            s.replacementHelper && s.replacementHelper,
              (window.taterAnimationToggle = class {
                #e = {
                  ...
                  focusOnButton: !1,
                  pubSub: {},
                  animationToggle: { class: "MC_AprilFools__cancel" },
                };
                #t = {};
                #a = { animationPaused: !1 };
                #o = { animationToggle: {}, parentElm: document.body };
                constructor(e) {
                  ...
                  !0 === this.#a.animationPaused
                    ...
                    document.dispatchEvent(
                      new CustomEvent("mcAprilFools", {
                        detail: { status: this.#a.animationPaused },
                      }),
                    ),
                    this.#i({ state: this.#a });
                }
            ...
            let l = null,
              d = () => {
                const e = { x: 0, y: 0, prevX: null, prevY: null };
                let t = 0,
                  a = !1;
  ...
  window.experimentStorage.expRequire(
    ...
    function () {
      ...
      var a = (t ? t.get("utils") : {}).url.locale(),
        o = a.lang + "-" + a.region;
      window.staticExperimentConfig({ htmlTemplateExtensions: {} }).extend(e),
        t.experimentBase({
          ...
          localizedContent: {
            ...
            "en-us": {
              ...
              healthbar: { ariaLabel: "Health bar" },
              potato: { title: "Poison potato" },
              toggle: {
            ...
            "da-dk": {
              ...
              healthbar: { ariaLabel: "Helbredsbjælke" },
              potato: { title: "Giftig kartoffel" },
              toggle: {
            ...
            "de-de": {
              ...
              healthbar: { ariaLabel: "Gesundheitsleiste" },
              potato: { title: "Giftkartoffel" },
              toggle: {
            ...
            "es-es": {
              ...
              healthbar: { ariaLabel: "Barra de salud" },
              potato: { title: "Patata venenosa" },
              toggle: {
            ...
            "fi-fi": {
              ...
              healthbar: { ariaLabel: "Terveyspalkki" },
              potato: { title: "Myrkkyperuna" },
              toggle: {
            ...
            "fr-ca": {
              ...
              healthbar: { ariaLabel: "Bar de santé" },
              potato: { title: "Patate empoisonnée" },
              toggle: {
            ...
            "fr-fr": {
              ...
              healthbar: { ariaLabel: "Barre de santé" },
              potato: { title: "Pomme de terre empoisonnée" },
              toggle: {
            ...
            "it-it": {
              ...
              healthbar: { ariaLabel: "Barra della salute" },
              potato: { title: "Patata avvelenata" },
              toggle: {
            ...
            "ja-jp": {
              ...
              healthbar: { ariaLabel: "健康バー" },
              potato: { title: "青くなったジャガイモ" },
              toggle: {
                offtext: "ジャガイモをオフにする",
                ontext: "ジャガイモをオンにする",
                offscreenreader:
            ...
            "nb-no": {
              ...
              healthbar: { ariaLabel: "Helsemeter" },
              potato: { title: "Giftpotet" },
              toggle: {
            ...
            "nl-nl": {
              ...
              healthbar: { ariaLabel: "Gezondheidsbalk" },
              potato: { title: "Gifaardappel" },
              toggle: {
            ...
            "pl-pl": {
              ...
              healthbar: { ariaLabel: "Pasek zdrowia" },
              potato: { title: "Trujący ziemniak" },
              toggle: {
            ...
            "pt-br": {
              ...
              healthbar: { ariaLabel: "Barra de vida" },
              potato: { title: "Batata venenosa" },
              toggle: {
            ...
            "pt-pt": {
              ...
              healthbar: { ariaLabel: "Barra de saúde" },
              potato: { title: "Batata venenosa" },
              toggle: {
                offtext: "Desligar as batatas",
                ontext: "Ligar as batatas",
            ...
            "ru-ru": {
              ...
              healthbar: { ariaLabel: "Шкала здоровья" },
              potato: { title: "Ядовитая картошка" },
              toggle: {
            ...
            "sv-se": {
              ...
              healthbar: { ariaLabel: "Hälsofält" },
              potato: { title: "Förgiftad potatis" },
              toggle: {
            ...
            "tr-tr": {
              ...
              healthbar: { ariaLabel: "Sağlık çubuğu" },
              potato: { title: "Zehirli patates" },
              toggle: {
